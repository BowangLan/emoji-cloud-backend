from EmojiCloud.EmojiCloud1 import plot_dense_emoji_cloud, generate_resized_emoji_images
from EmojiCloud.canvas import MaskedCanvas, EllipseCanvas
from EmojiCloud.vendors import TWITTER, GOOGLE
from EmojiCloud.util import timeit
...
def test_function():
    ...
    p = plot_dense_emoji_cloud(canvas, GOOGLE, dict_weight)
    # list_sorted_emoji, list_resize_img = generate_resized_emoji_images(
    #     TWITTER, dict_weight, canvas.area, {}, 1.1)
